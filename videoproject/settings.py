...
ALLOWED_HOSTS = ['106.14.163.168','127.0.0.1','localhost']
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'samparker19990716@163.com'
EMAIL_HOST_PASSWORD = '19990716'
...
STATIC_ROOT = os.path.join(BASE_DIR, '/home/samparker/site/django_video/assets')
